...
btn1 = Button(root, text="1", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(1))
btn2 = Button(root, text="2", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(2))
btn3 = Button(root, text="3", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(3))
btn4 = Button(root, text="4", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(4))
btn5 = Button(root, text="5", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(5))
btn6 = Button(root, text="6", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(6))
btn7 = Button(root, text="7", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(7))
btn8 = Button(root, text="8", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(8))
btn9 = Button(root, text="9", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(9))
btn0 = Button(root, text="0", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka(0))
koma = Button(root, text=".", padx=30, bg="black",
              fg="white", pady=20, command=lambda: angka("."))

tambah = Button(root, text="+", padx=30, bg="#FF9933", fg="black", pady=20, command=tambah)
kurang = Button(root, text="-", padx=30, bg="#FF9933",fg="black", pady=20, command=kurang)
kali = Button(root, text="x", padx=30, bg="#FF9933", fg="black", pady=20, command=kali)
bagi = Button(root, text="/", padx=30, bg="#FF9933", fg="black", pady=20, command=bagi)
pangkat = Button(root,text="x2",padx = 30,bg="#FF9933",fg="black", pady = 20,command=pangkat)
akar = Button(root,text="sq2",padx = 25,bg="#FF9933",fg="black", pady = 20,command=akar)
hapus = Button(root, text="C", padx=30, bg="#FF9933", fg="black", pady=20, command=hapus)
samadengan = Button(root, text="=", padx=70, bg="#FF9933", fg="black", pady=20, command=samadengan)
